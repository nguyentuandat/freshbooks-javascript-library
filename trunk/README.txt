...
This is a Javascript library for FreshBooks API (http://developers.freshbooks.com/overview/). If you don't want to deal with XML directly this might be the tool for you.
